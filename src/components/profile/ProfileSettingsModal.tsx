	...
	const getDeleteModalContent = () => {
		...
		const content = {
			...
			all: {
				...
				message: t(
					'Are you sure you want to clear ALL local storage data? This will remove settings, properties, and secrets permanently.',
				),
				items: [
			...
			>
				<form onSubmit={handleSubmit} className='profile-form'>
					...
					<div className='warning-message'>
						...
						<p>
							{t(
								'This does NOT delete your projects, files, and account data.',
							)}
						</p>
					</div>
