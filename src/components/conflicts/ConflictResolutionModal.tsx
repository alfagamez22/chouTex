        ...
        >
            <div className="conflict-resolution">
                ...
                <div className="conflict-actions">
                    <button className="button secondary" onClick={() => recordAndAdvance({ action: 'keep-local' })}>
                        {t('Keep Local')}
                    </button>
                    <button className="button secondary" onClick={() => recordAndAdvance({ action: 'keep-remote' })}>
                        {t('Keep Remote')}
                    </button>
                    {!current.isBinary && (
                        <button
                            className="button primary"
                            onClick={() => recordAndAdvance({ action: 'merged', content: mergedContent })}
