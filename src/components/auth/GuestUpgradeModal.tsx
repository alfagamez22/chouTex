        ...
        <div className="upgrade-modal-content">
          <div className="upgrade-info">
            ...
            <div className="storage-notice">
              <p>
                <strong>{t('Important: ')}</strong>{t('chouTex stores all data locally in your browser. Your projects will persist until you clear browser data, uninstall the browser, or use a different device. For long-term storage, regularly export your projects.')}
